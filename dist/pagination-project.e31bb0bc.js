...
var getContent = function getContent(start, end) {
  var stopPagination = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  ...
  _axios.default.get("http://localhost:3000/post?_start=".concat(start, "&_end=").concat(end)).then(function (res) {
    ...
    var countPaginationNum = Math.floor(totalCount / perPageCount);
...
var renderPostList = function renderPostList(postList) {
  ...
  postList.forEach(function (postItems, i) {
...
var renderPagination = function renderPagination(countPaginationNum) {
  ...
  var _loop = function _loop() {
    ...
    pageItem.addEventListener("click", function (e) {
      ...
      getContent(start, end, true); // remove all active class
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "43341" + '/');
...
//# sourceMappingURL=/pagination-project.e31bb0bc.js.map